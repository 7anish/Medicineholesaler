        ...
        <nav className='w-full  m-0 md:pr-0 sm:py-4 md::py-4   bg-white font-poppins  pb-3'>
            <div className='xl:flex justify-between items-center font-poppins px-2  md:px-20'>
                <div className='flex xl:justify-center items-center justify-between '>
                    ...
                    <div onClick={() => setOpen(!open)} className='text-3xl xl:hidden flex items-center py-4'>
                        <ion-icon name={open ? 'close' : 'menu-outline'}></ion-icon>
                    </div>
                </div>
                <div className={`flex  xl:flex-row xl:w-1/2 w-full xl:z-auto bg-white z-10 transition-all duration-300 ease-in sm:justify-end gap-10 sm:gap-4 items-center xl:py-0 py-4 absolute xl:static ${open ? 'left-0' : 'left-[-100%]'} flex-col`}>
