    ...
    if (error) {
        return (
            <div className="w-full h-fit rounded-3xl flex flex-col justify-between items-center py-7 px-4">
                ...
                <h1 className='text-3xl font-bold font-poppins text-center py-20 text-orange-600'>Error in fetchin Category !!!</h1>
            </div>
        )
    }
    return (
            ...
            <div className="w-full h-fit rounded-3xl flex flex-col justify-between items-center py-7 px-4">
                ...
                </div>
                {
                    catdata?.map((item) => {
                        return (
                            <>
                                <h1 className="w-full text-center md:text-left sm:px-16 font-palyfair text-2xl md:text-3xl lg:text-3xl py-3 font-bold text-orange-600 capitalize" data-aos="fade-up" id={item.category}>{(item.category).split('-').join(' ')}</h1>
